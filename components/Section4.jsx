...
export default function Section4() {
  return (
    <div className='bg-black w-screen' id='click'>
      <div className='h-20 w-full bg-black/80 sticky top-0 left-0 px-10 sm:px-20  z-10 flex items-center tracking-[6px] uppercase text-sm sm:text-md'>

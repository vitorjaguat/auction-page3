...
export default function Section6() {
  return (
    <div className='w-screen bg-black' id='faucet'>
      <div className='h-20 w-full bg-black/80 sticky top-0 left-0 px-10 sm:px-20 flex items-center tracking-[6px] text-sm sm:text-md z-[100]'>
      ...
      <div className=''>
        ...
        <div className='px-2 sm:px-10 pt-10 pb-20 claim-widget font-din'>
          {/* <a
